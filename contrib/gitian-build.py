...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'linux-arm64', '--destination', '../gitian.sigs/', '../dsw/contrib/gitian-descriptors/gitian-linux-arm_64.yml'])
