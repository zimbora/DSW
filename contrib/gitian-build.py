...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call(['mkdir', '-p', '../gitian.sigs/'+args.version])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', 'linux-x86', '--destination', '../gitian.sigs/'+args.version+'/', '../dsw/contrib/gitian-descriptors/gitian-linux-x86_64.yml'])
        ...
        subprocess.check_call(['mkdir', '-p', '../gitian.sigs/'+args.version])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'linux-arm64', '--destination', '../gitian.sigs/'+args.version+'/', '../dsw/contrib/gitian-descriptors/gitian-linux-arm_64.yml'])
    ...
    if args.windows:
        ...
        subprocess.check_call(['mkdir', '-p', '../gitian.sigs/'+args.version])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'/win-unsigned', '--destination', '../gitian.sigs/'+args.version+'/', '../dsw/contrib/gitian-descriptors/gitian-win.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call(['mkdir', '-p', '../gitian.sigs/'+args.version])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'/osx-unsigned', '--destination', '../gitian.sigs/'+args.version+'/', '../dsw/contrib/gitian-descriptors/gitian-osx.yml'])
