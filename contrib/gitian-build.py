...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call(['mkdir', '-p', '../gitian.sigs/'+args.version])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', 'linux-arm64', '--destination', '../gitian.sigs/'+args.version+'/', '../dsw/contrib/gitian-descriptors/gitian-linux-arm_64.yml'])
    ...
    if args.windows:
        ...
        subprocess.check_call(['mkdir', '-p', '../gitian.sigs/'+args.version])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', 'win-unsigned', '--destination', '../gitian.sigs/'+args.version+'/', '../dsw/contrib/gitian-descriptors/gitian-win.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call(['mkdir', '-p', '../gitian.sigs/'+args.version])
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', 'osx-unsigned', '--destination', '../gitian.sigs/'+args.version+'/', '../dsw/contrib/gitian-descriptors/gitian-osx.yml'])
